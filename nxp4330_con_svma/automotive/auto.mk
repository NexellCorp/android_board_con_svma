...
#$(call inherit-product, device/nexell/con_svma/nxp4330_con_svma/device_common.mk)
...
BOARD_SEPOLICY_DIRS += \
    device/generic/car/nxp4330_con_svma/sepolicy

BOARD_IS_AUTOMOTIVE := true
TARGET_USES_CAR_FUTURE_FEATURES := true

ifeq ($(QUICKBOOT), 1)
$(call inherit-product, device/nexell/con_svma/nxp4330_con_svma/automotive/car.mk)
else
