...
#$(call inherit-product, device/nexell/con_svma/s5p6818_con_svma/device_common.mk)
...
BOARD_SEPOLICY_DIRS += \
    device/generic/car/s5p6818_con_svma/sepolicy

BOARD_IS_AUTOMOTIVE := true
TARGET_USES_CAR_FUTURE_FEATURES := true

ifeq ($(QUICKBOOT), 1)
$(call inherit-product, device/nexell/con_svma/s5p6818_con_svma/automotive/car.mk)
else
