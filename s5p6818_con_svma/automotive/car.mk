...
$(call inherit-product, device/nexell/con_svma/s5p6818_con_svma/automotive/car_base.mk)
...
# Boot animation
PRODUCT_COPY_FILES += \
    device/nexell/con_svma/s5p6818_con_svma/bootanimation.zip:system/media/bootanimation.zip
